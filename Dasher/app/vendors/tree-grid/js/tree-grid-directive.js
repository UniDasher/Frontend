(function () {
  angular
    .module('all-manage.html', [])
    .run([
      '$templateCache',
      function ($templateCache) {
        $templateCache.put('all-manage.html',
          ...
          //"       <th></th>\n" +
          //"       <th ng-repeat=\"col in colDefinitions\"></th>\n" +
          //"     </tr>\n" +
          //"   </thead>\n" +
          "   <tbody>\n" +
          ...
          "             <div type='button' class='add-new-branch btn btn-default' ng-click=\"addNewSubdirectories($event)\"><i class='fa fa-lg fa-plus'></i></div>" +
          "             <button type='button' class='btn btn-default' ng-click=\"updateSubdirectorieName($event)\"><i class='fa fa-lg fa-pencil'></i></button>" +
          "             <button type='button' class='btn btn-default' ng-click=\"deleteSubdirectories($event)\"><i class='fa fa-lg fa-trash-o'></i></button>" +
          "         </div>"+
          "       </td>\n" +
          "     </tr>\n" +
          "   </tbody>\n" +
  ...
  angular
    ...
    .directive('treeGrid', ['$timeout', 'treegridTemplate',
      function ($timeout, treegridTemplate) {
        return {
          restrict   : 'E',
          ...
          link       : function (scope, element, attrs) {
            ...
            if (!scope.treeData) {
	          ...
	          scope.addNewSubdirectories= function(tar){
		          var tar=tar.target;
		          var add=$(tar).parents('.tree-grid-row');
		          console.log(add);
		          $(add).append("添加新标签所在地")
	          }
	          scope.updateSubdirectorieName= function(tar){
		          var tar=tar.target;
		          var add=$(tar).parents('.tree-grid-row');
		          console.log(add);
		          $(add).append("更改标签名")
	          }
	          scope.deleteSubdirectories= function(tar){
		          var tar=tar.target;
		          var add=$(tar).parents('.tree-grid-row');
		          console.log(add);
		          $(add).append("删除对应标签")
    ...
    .provider('treegridTemplate', function () {
      var templatePath = 'all-manage.html';
